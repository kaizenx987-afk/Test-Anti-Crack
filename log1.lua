...
function autoBypass()
  ...
  pcall(function()
-- ==========================================
-- GRUPO 1 (h00 00 80 D2 C0 03 5F D6)
-- ==========================================
...
-- ==========================================
-- GRUPO 2 (hC0 03 5F D6 - Kasama na ang Autoban Bypass)
-- ==========================================
HexPatches.MemoryPatch("libanogs.so", 0x261DC0, "hC0 03 5F D6", 32) -- <--- Nandito na siya ngayon
